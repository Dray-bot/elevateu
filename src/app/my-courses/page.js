  ...
  return (
    <section className="min-h-screen bg-gradient-to-b from-orange-100 to-white px-6 py-16">
      <div className="max-w-6xl mx-auto">
        <h1 className="text-3xl md:text-5xl font-bold text-gray-800 mb-8">My<span className="text-orange-500"> Courses</span></h1>

        {enrolledCourses.length === 0 ? (
          <div className="text-center text-gray-600">
            <p>You haven't enrolled in any courses yet.</p>
            <Link href="/courses" className="mt-4 inline-block px-6 py-3 bg-orange-500 text-white rounded-md hover:bg-orange-600 transition">
              Browse Courses
            </Link>
          </div>
        ) : (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {enrolledCourses.map((course) => (
              <div key={course.slug} className="bg-white rounded-xl shadow-md p-6 hover:shadow-lg transition flex flex-col justify-between">
                <div>
